...
> **정본(canonical) 앱:** 이 저장소의 루트입니다. 설치·실행·검사·커밋·푸시는 모두 `~/Desktop/프로젝트/뭐할까`에서 수행합니다. 별도의 중첩 앱 디렉터리는 두지 않습니다.
...
혼자놀기 코스 데이터는 삭제하지 않고 향후 Bucket/Plan 후보로 재검토할 수 있도록 보관합니다. 새 기능과 데이터는 루트의 활성 디렉터리에만 추가하고, 이전 MVP 자료는 `archive/honja-nolgi/`에서 관리합니다.
