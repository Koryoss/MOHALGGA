/**
 * Runnable sanity check for the module (not a formal test suite, not part
 * of the app bundle). Run with a plain Node/tsx environment, not Expo:
 *   npx tsx lib/candidates/demo.ts
 */
