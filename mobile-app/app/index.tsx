...
export default function Home() {
  ...
  const makeCandidates = (nextSituation: Situation, selectedMode = mode, selectedPartner = partner) => {
    setMode(selectedMode); setPartner(selectedPartner); setSituation(nextSituation); setCandidates([]); setVotes({}); setVoterIndex(0); setShowResult(false); setDecided(false); setLearnIndex(null); setScreen("match");
  };
